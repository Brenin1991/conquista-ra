...
class ScreenManager {
    ...
    registerDefaultScreens() {
        ...
        if (window.GameScreen) {
            this.registerScreen('game', new GameScreen());
            console.log('✅ GameScreen disponível');
        } else {
            console.error('❌ GameScreen não encontrada');
        }

        if (window.InteracaoScreen) {
            this.registerScreen('interacao', new InteracaoScreen());
            console.log('✅ InteracaoScreen disponível');
        } else {
            console.error('❌ InteracaoScreen não encontrada');
        }
